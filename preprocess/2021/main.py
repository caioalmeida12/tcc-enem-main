...
"""
Esse script tem como objetivo realizar o pré-processamento dos microdados do Enem 2021.
O pré-processamento consiste em:
1. Carregar os microdados do Enem 2021 (./microdados_enem_2021/DADOS/MICRODADOS_ENEM_2021.csv).
...
5. Salvar os dados pré-processados em um arquivo CSV (./microdados_enem_2021/PREPROCESS/PREPROCESSED_DATA.csv).
"""
...
def main():
    caminho_saida = (
        "./preprocess/2021/microdados_enem_2021/PREPROCESS/PREPROCESSED_DATA_100K.csv"
    )

    preprocessados = pipe(
        "./preprocess/2021/microdados_enem_2021/DADOS/MICRODADOS_ENEM_2021_100K.csv",
        carregar_arquivo,
